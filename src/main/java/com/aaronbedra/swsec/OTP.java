...
public abstract class OTP implements CoProduct8<OTP.OTP1, OTP.OTP2, OTP.OTP3, OTP.OTP4, OTP.OTP5, OTP.OTP6, OTP.OTP7, OTP.OTP8, OTP> {
    ...
    public static final class OTP1 extends OTP {
        public static final OTP1 INSTANCE = new OTP1();
    ...
    public static final class OTP2 extends OTP {
        public static final OTP2 INSTANCE = new OTP2();
    ...
    public static final class OTP3 extends OTP {
        public static final OTP3 INSTANCE = new OTP3();
    ...
    public static final class OTP4 extends OTP {
        public static final OTP4 INSTANCE = new OTP4();
    ...
    public static final class OTP5 extends OTP {
        public static final OTP5 INSTANCE = new OTP5();
    ...
    public static final class OTP6 extends OTP {
        public static final OTP6 INSTANCE = new OTP6();
    ...
    public static final class OTP7 extends OTP {
        public static final OTP7 INSTANCE = new OTP7();
    ...
    public static final class OTP8 extends OTP {
        public static final OTP8 INSTANCE = new OTP8();
